...
class AuthorPaperFetcher extends Model {
    ...
    public function __construct($author, $ordering = '') {
        ...
        //Format author names
        $this->synonym_author_list = array_map([$this, 'format_author_name'], $this->synonym_author_list);
        ...
        } elseif (count(explode(' ', $this->author_kwd)) > 1) {
