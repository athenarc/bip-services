...
class PreviousUrlChecker {
    ...
    public static function msg_based_on_previous_url() {
         ...
         */
        elseif (strpos($prev_url, 'site/sendmail') !== false) {
         ...
         */
        elseif ((strpos($prev_url, 'site/passreset') !== false && strpos($current_url, 'site/passreset') !== false)) {
            return 'Could not reset password, please try again!';
        }
        /*
         * Default case should return no message
         */
        elseif ((strpos($prev_url, 'likeunavailable') !== false && Yii::$app->user->isGuest)) {
