...
class ChartData extends Model {
    ...
    public static function calculate($pop_class, $inf_class, $imp_class, $cc_class) {
        ...
        return self::format_chart_data($pop_class, $inf_class, $imp_class, $cc_class);
    }
    ...
    public static function calculateForConcepts($concepts) {
        ...
        foreach ($concepts as $key => $concept) {
            $concept_data = self::format_chart_data($concept['pop_class'], $concept['inf_class'], $concept['imp_class'], $concept['cc_class']);
