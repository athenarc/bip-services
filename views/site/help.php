...
<div class="container site-about">
	...
	<?= Html::img("@web/img/help/help-1.png", ['alt' => 'Login', 'class' => 'img-responsive screenshot center-block']) ?>
	
	<p class='help-text'>
		Click the "<?= Html::a('Sign up', Url::to(['site/signup']), [ 'class' => 'main-green' ]) ?>" option that exists in the Login page.
	</p>

	<?= Html::img("@web/img/help/help-2.png", ['alt' => 'Sign up', 'class' => 'img-responsive screenshot center-block']) ?>

	<p class='help-text'>
		Fill out the required fields in the form.
	</p>

	<?= Html::img("@web/img/help/help-3.png", ['alt' => 'Sign up form', 'class' => 'img-responsive screenshot center-block']) ?>

	<p class='help-text'>
		Congratulations! You have created a BIP! Services account!
	</p>

	<?= Html::img("@web/img/help/help-4.png", ['alt' => 'Sign up form', 'class' => 'img-responsive screenshot center-block']) ?>
	...
	<?= Html::img("@web/img/help/help-5.png", ['alt' => 'Create Scholar profile', 'class' => 'img-responsive screenshot center-block']) ?>
	...
	<?= Html::img("@web/img/help/help-6.png", ['alt' => 'Create Scholar profile', 'class' => 'img-responsive screenshot center-block']) ?>
